...
\color{black}
 ...
 \Return ndSHD2{\color{purple}-ext}($\mathit{vmap}$, $\mathit{emap}$)\;
 \caption{ndSHD2-ext}
...
\If{$\mathit{hasUnmatchedEdge}()$} {
	$(e_S, p_T) \longleftarrow \mathit{GetNextEdgePathPair}()$\;
	\If{{\color{purple}$\mathit{isUnnecessarilyLong}(p_T) \lor$} $\mathit{wouldPrune}${\color{purple}-ext}$(\mathit{vmap}, \mathit{emap} \cup \{(e_S, p_T)\})$} {
  		\textbf{continue}\;
  	}\color{purple}
  	\If{$\mathit{contraction} \land \lnot \mathit{chainsCompatible}(\mathit{emap}, \mathit{from}(e_S), \mathit{to}(e_S), p_T)$} {
  		\textbf{continue}\;
  	}\color{black}
  	$\mathit{emap} \longleftarrow \mathit{emap} \cup \{(e_S, p_T)\}$\;
  ...
  $\mathit{emap} \longleftarrow \mathit{emap} \cap \{(e_S, p_T)\}$\;
	...
	$(v_S, v_T) \longleftarrow \mathit{GetNextNodePair}()$\;
	\If{$\mathit{wouldPrune}${\color{purple}-ext}$(\mathit{vmap} \cup \{(v_S, v_T)\}, \mathit{emap})$} {
  		\textbf{continue}\;
  	}
  	$\mathit{vmap} \longleftarrow \mathit{vmap} \cup \{(v_S, v_T)\}$\;
  	$\mathit{found} \longleftarrow \mathit{ndSHD2}${\color{purple}-ext}$(\mathit{vmap}, \mathit{emap})$\;
