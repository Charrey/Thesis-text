...
\begin{tikzpicture}
    ...
    \draw[draw=white] (10.5,2.5)         node[anchor=south] {$y_0 0$};
    \draw[draw=white] (10.5,2)           node[anchor=south] {$y_1 0$};    
    \draw[draw=white] (10.5,1.5)         node[anchor=south] {$y_0 0$};
    \draw[draw=white] (10.5,1)           node[anchor=south] {$y_1 0$};
    \draw[draw=white] (10.5,0.5)         node[anchor=south] {$y_2 0$};
    \draw[draw=white] (10.5,0)           node[anchor=south] {$y_3 0$};
    \draw[draw=white] (10.5,-0.5)         node[anchor=south] {$y_2 0$};
    \draw[draw=white] (10.5,-1)           node[anchor=south] {$y_3 0$};
