...
%        (16,5.3676)
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Space usage of the algorithm with each path iterator. Source vertices are ordered by GreatestConstrainedFirst, target vertices are ordered by degree, contraction is disabled and no pruning is used.}
