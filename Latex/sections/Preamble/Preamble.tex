...
\usepackage{hyperref}
\hypersetup{
pdftitle={FPGA-on-FPGA emulation using subgraph homeomorphism},
pdfauthor={Pim van Leeuwen}
}
...
\newcommand{\doctitle}{FPGA-on-FPGA emulation using subgraph homeomorphism}
